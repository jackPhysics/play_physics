...
var objRadA = 10;
var objRadB = 10;//15 = 10 degrees angular size; 5 = 2 degrees; 10 = 5 degrees
...
function plotNewFrame(){
  ...
  /*  if(moonHigh>-16){
    ...
    ctx.fillStyle = "red";
    ctx.font = "24px Arial";
    ctx.fillText("moon below horizon", canvW/20, 1.5*canvH/6);}
    ...
    //SMALL MOON
      ...
      ctx.beginPath();
      moonNot = "black";//whatSky;//sunCol;//whatSky;
...
//} //goflag end bracket
  ...
  function changeMB(n){
    ...
    function changeUB(n){
        ...
        var moonT_ms = 1000*60*60*24*29.53058770576;//moon's sydonic period in ms - for phase
        ...
        //time and date now is found from positions of sliders
          ...
          //find full time now in milliseconds: date in year + start date + time of day
          ...
          //calculations to find phase of moon
          //find difference between date/time now and moonZero day (when mon day is known = 0)

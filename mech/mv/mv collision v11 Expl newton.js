...
*/
    ...
    document.getElementById("myRangeAS").value=5;
...
function calcCollisionAonB(){
  ...
  //setTimeout(dummyPause, 2000);

    oldVelA=objVelA;
    oldVelB=objVelB;
    //alert(""+elasticity+" "+oldVelA+" "+oldVelB);
    objVelB = (2*startEnergy/(Math.pow(objMassB,2)/objMassA+objMassB));
    objVelB = Math.pow(objVelB, 0.5);
    objVelA = -(objMassB*objVelB)/objMassA;
    ...
    springT2=time;
    springTr2=turn;
    document.getElementById("dummy3").innerHTML="<br>time = "
      + printNumber(time)+" "+timeUnits;

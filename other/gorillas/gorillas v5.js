...
let shotSinceA = 0;
let shotSinceB = 0;
let gorCoords = [7, 0, 7, 5, 1, 5, 1, 8, 6, 8, 6, 11, 5, 12, 
    5, 19, 8, 19, 7, 18, 7, 15, 12, 15, 12, 18, 
    11, 19, 14, 19, 14, 12, 13, 11, 13, 8, 18, 8,
    18, 5, 12, 5, 12, 0];
let coordsLen = gorCoords.length;
...
window.onload = function () {
  ...
  drawKong(ctx, gorX, gorY, gorACol);
/*
  ...
  drawKong(ctx, gorX, gorY, gorBCol);
...
function drawKong(ctx, gorX, gorY, gorCol){

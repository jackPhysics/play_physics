...
var nextNumb = 0;
  ...
  imageArray[k].style.left=Math.floor(k/9)*pieceSize*2+60+"px";//(k-(Math.floor(k/10)*10))+100+"px";//k*60+"px";
  imageArray[k].style.top=(k-Math.floor(k/9)*9)*pieceSize*0+20+"px";//k*60+"px";
  piecesLeft[k] = Math.round(Math.floor(k/9)*pieceSize*2+60);
  piecesTop[k] = Math.round((k-Math.floor(k/9)*9)*pieceSize*0+20);

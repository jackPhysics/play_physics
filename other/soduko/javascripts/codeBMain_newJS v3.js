...
var colorsArray = ["-","red", "yellow", "green", "blue", "violet", "orange", "turquoise", "brown", "indigo", "pink", "silver", "dgreen", "dred", "dblue"];
var colorsArrayRepeat = ["-","red", "yellow", "green", "blue", "violet", "orange", "turquoise", "brown", "indigo", "pink", "silver", "dgreen", "dred", "dblue"];
...
function checkCode(){
  ...
  for(c=0;c<noOfColumns;c++){
    ...
    if(d!=c){
    if(dummyArray[c]==finderArray[d]){
      whitePegs++;
      dummyArray[c]="X";//break is so it only counts the colour once
    }}}
  }

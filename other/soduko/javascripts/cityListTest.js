...
/*
  ...
  for(var c=0; c<noOfCities; c++){//label who in control of each city using original list
    ...
    var cityControlClass = 'side'+cityControlA[c]+c;
    var sideInControl = document.getElementById(cityControlClass).getAttribute("class");//find class of the side in control

 ...
 function placePieceHere(event) //move the active piece into a new position
{
    ...
    console.log(""+turnNumbRow+"left:"+xpos/boardSize+ " top:"+ypos/boardSize);
    var xSquare = Math.round(((xpos/boardSize)-137)/30);
    var ySquare = Math.round(((ypos/boardSize)-76)/30);
    if(ySquare==+turnNumbRow-1)(finderArray[xSquare]="-");
  ...
  if(mouseActive==1){
    ...
    //alert("left:"+xpos+ " top:"+ypos);
    //console.log("left:"+xpos/boardSize+ " top:"+ypos/boardSize);
  ...
  if(xpos/boardSize>33&&xpos/boardSize<83&&ypos/boardSize>44&&ypos/boardSize<58){//touching 'check code' button
    ...
    else if(xpos/boardSize>(150+noOfColumns*30)&&xpos/boardSize<(210+noOfColumns*30)&&ypos/boardSize>44&&ypos/boardSize<58){//touching 'check code' button
      drawQuit();
      //myVar = setTimeout(checkCode2, 100);
    }
}

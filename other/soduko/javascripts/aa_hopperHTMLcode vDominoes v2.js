...
+'<td>&nbsp;&nbsp;<a href="javascript:newColorTiles()"  id="btn14"  >re-colour ALL</a></td>'
+'<td>&nbsp;&nbsp;<a class="neut"  href="javascript:newColorTiles2()"  id="btn15"  >re-colour outside</a></td>'
+'<td>&nbsp;&nbsp;<a href="javascript:newColorTiles3()"  id="btn5"  >re-colour inside</a></td>'
+'<td>&nbsp;&nbsp;<a href="javascript:newColorTilesOne()"  id="btn7"  >re-colour ONE</a></td>'
+'<td>&nbsp;&nbsp;<a href="javascript:oneColor()" id="colorBtn">HINT!</a></td>'
+'<td>&nbsp;&nbsp;<a href="javascript:toggleColors()" id="colorBtn">ANSWERS!</a></td>'
+'</tr><tr id="aiwrow">'
+'<td>&nbsp;&nbsp;<a class="neut" href="javascript:d7_window()"  id="btn6"  >D6+</a></td>'
+'<td>&nbsp;&nbsp;<a class="aiw" href="javascript:unmarkAll()"  id="btn11"  >show all tiles</a></td>'
+'<td>&nbsp;&nbsp;<a class="aiw" href="javascript:unmarkAllTrans()"  id="btn12"  >see-thru tiles</a></td>'
+'<td>&nbsp;&nbsp;<a class="aiw" href="javascript:unmarkAllTransOne()"  id="btn13"  >see-thru ONE</a></td>'
+'<td>&nbsp;&nbsp;<a class="neut" href="javascript:makeSmaller()"  id="btn61"  >ZOOM OUT</a></td>'
+'<td>&nbsp;&nbsp;<a class="aiw" href="javascript:makeBigger()"  id="btn10"  >ZOOM IN</a></td>'
+'<td>&nbsp;&nbsp;<a class="aiw" href="javascript:toggleDisplayMode()" id="displayBtn">Toggle Dots / Numbers</a></td>'
+'</tr></table>';

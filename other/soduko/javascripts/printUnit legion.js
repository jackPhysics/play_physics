...
var noOfTile = -1;
var letOfTile = [ "B", "C", "D","F", "G", "H", "J",
"K", "L", "M", "N", "P", "Q", "R","S", "T", "V","W", "X", "Y",];
var letOfTile2 = [ "I", "II", "III","IV", "V", "VI", "VII",
...
//countOutUnits=0;dumFont=24*unitScale;
    ...
    ctx.fillStyle = "black";//textColorThis;
        ...
        ctx.fillText(""+noOfTile,i2*unitSize+100*unitScale,j2*unitSize+155*unitScale);}
        else{
        ctx.fillText(""+noOfTile,i2*unitSize+100*unitScale,j2*unitSize+155*unitScale);
        }
        //countOutUnits++;
  ...
  ctx.font = "bold "+dumFont+"px Arial";
  //ctx.font = "30px Arial";
  ctx.fillStyle = "Yellow";//textColorThis;
  if(blackTextFlag){ctx.fillStyle = "Yellow";}//"Black";
  ctx.textAlign = "center";
  ctx.textBaseline = "middle";
  ctx.lineWidth = "2";
  ctx.fillText(""+tileLabelsA[noOfImgPrnt],i2*unitSize+90*unitScale,j2*unitSize+100*unitScale, 150);
